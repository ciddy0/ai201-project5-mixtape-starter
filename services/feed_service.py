...
def get_friends_listening_now(user_id: str) -> list[dict]:
    ...
    # "Listening now" means listened today — anchor the cutoff to today's UTC
    # midnight, not a rolling 24h window (which would keep yesterday's evening
    # listens around until the same time the next day).
